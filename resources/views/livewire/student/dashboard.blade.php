            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                        Here is your current thesis progress. Your status is: <strong>{{ $user->status_text }}</strong>
                    </p>
                                    ...
                                    <li class="relative {{ !$loop->last ? 'pr-8 sm:pr-20' : '' }}">
                                        @if ($isCompleted)
                                            ...
                                            <a href="#" class="relative flex h-8 w-8 items-center justify-center rounded-full bg-indigo-600 hover:bg-indigo-900">
                                                <svg class="h-5 w-5 text-white" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.052-.143z" clip-rule="evenodd" /></svg>
                                            </a>
                                        @elseif ($isCurrent)
                                            {{-- Current Step --}}
                                            <div class="absolute inset-0 flex items-center" aria-hidden="true">
                                            ...
                                            <a href="#" class="relative flex h-8 w-8 items-center justify-center rounded-full border-2 border-indigo-600 bg-white dark:bg-gray-800" aria-current="step">
                                        ...
                                        @else
                                            ...
                                            <a href="#" class="group relative flex h-8 w-8 items-center justify-center rounded-full border-2 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 hover:border-gray-400">
                                        ...
                                        <div class="absolute -bottom-10 w-max text-center">
                                            <p class="text-xs font-semibold {{ $isCompleted || $isCurrent ? 'text-indigo-600 dark:text-indigo-400' : 'text-gray-500' }}">{{ $step['name'] }}</p>
                                        </div>
                                    </li>
                                @endforeach
                            </ol>

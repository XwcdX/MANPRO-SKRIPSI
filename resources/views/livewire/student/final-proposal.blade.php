...
new class extends Component {
    ...
    public function submit(SubmissionService $service)
    {
        ...
        if (! $this->proposal_file instanceof TemporaryUploadedFile) {
            Log::error('Objek file tidak valid.', ['type' => get_class($this->proposal_file)]);
        ...
        try {
            // simpan submission
            $response = $service->submitFinalProposal(
                $this->user,
                $this->proposal_file,
            );
